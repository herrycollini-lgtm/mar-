...
async function loadAvailability() {
  ...
  try {
    ...
    if (!hasAvailable) {
      ...
      hint.textContent = "Per questa data i coperti disponibili sono terminati.";
...
bookingForm.addEventListener("submit", async function (event) {
  ...
  try {
    ...
    document.querySelector("#confirmationSummary").textContent = "";
    ...
    bookingSubmit.disabled = true;
    loadAvailability();
    setBookingMessage("La prenotazione è stata salvata.", "success");
  } catch (error) {
